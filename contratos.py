...
layout = html.Div([
    ...
    html.Div(
        html.Div([
            ...
            html.Div('OBS: Valores Consolidados até dezembro 2020',className="mb-4 pl-3"),
            ...
            ,className="p-4"),    #dcc.Input(id="input-1", type="email", placeholder="name@example.com", className="form-control mt-4"),
        className="bg-branco"
    ),
    dbc.Modal(
        modal,
