...
def gera_grafico_cnt(contrato,valorContrato,filtros,inicioData,fimData,mes_ano,mwh_mwm,default):
    ...
    if mwh_mwm == 'MWm':
        ...
        fig1.update_layout(yaxis=dict(title='MWm'))
    else:
        fig.update_layout(yaxis=dict(title='MWh'))
        fig1.update_layout(yaxis=dict(title='MWh'))  
...
def gera_grafico_cts(contrato,valorContrato,filtros,inicioData,fimData,mes_ano,uni_tot,default):
