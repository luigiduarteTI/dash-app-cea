...
def rotina_todos_tipo_contrato(value_todos,value,n_click):
    ctx =  dash.callback_context
    input_id = ctx.triggered[0]["prop_id"].split(".")[0]
    valores = value
    boolean = True
    seta = html.Span('',className="seta ml-auto", id="seta")
    if(input_id == 'limpar-alteracoes'):
...
def rotina_todos_submercado(value_todos,value,n_click):
    ctx =  dash.callback_context
    input_id = ctx.triggered[0]["prop_id"].split(".")[0]
    valores = value
    boolean = True
...
def rotina_todos_leilao(value_todos,value,n_click):
    ctx =  dash.callback_context
    input_id = ctx.triggered[0]["prop_id"].split(".")[0]
    valores = value
    boolean = True
...
def rotina_todos_status(value_todos,value,n_click):
    ctx =  dash.callback_context
    input_id = ctx.triggered[0]["prop_id"].split(".")[0]
    valores = value
    boolean = True
...
def rotina_todos_produto(value_todos,value,n_click):
    ctx =  dash.callback_context
    input_id = ctx.triggered[0]["prop_id"].split(".")[0]
    valores = value
    boolean = True
...
def rotina_todos_vendedor(value_todos,value,n_click):
    ctx =  dash.callback_context
    input_id = ctx.triggered[0]["prop_id"].split(".")[0]
    valores = value
    boolean = True
...
def rotina_todos_inicio_suprimento(value_todos,value,n_click):
    ctx =  dash.callback_context
    input_id = ctx.triggered[0]["prop_id"].split(".")[0]
    valores = value
    boolean = True
...
def rotina_todos_fim_suprimento(value_todos,value,n_click):
    ctx =  dash.callback_context
    input_id = ctx.triggered[0]["prop_id"].split(".")[0]
    valores = value
    boolean = True
